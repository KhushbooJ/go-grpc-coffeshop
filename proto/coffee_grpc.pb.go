...
const (
	CoffeeShop_GetMenu_FullMethodName        = "/proto.CoffeeShop/GetMenu"
	CoffeeShop_PlaceOrder_FullMethodName     = "/proto.CoffeeShop/PlaceOrder"
	CoffeeShop_GetOrderStatus_FullMethodName = "/proto.CoffeeShop/GetOrderStatus"
)
...
type CoffeeShopClient interface {
	GetMenu(ctx context.Context, in *NoParam, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Menu], error)
...
func (c *coffeeShopClient) GetMenu(ctx context.Context, in *NoParam, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Menu], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &CoffeeShop_ServiceDesc.Streams[0], CoffeeShop_GetMenu_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[NoParam, Menu]{ClientStream: stream}
...
type CoffeeShopServer interface {
	GetMenu(*NoParam, grpc.ServerStreamingServer[Menu]) error
...
func (UnimplementedCoffeeShopServer) GetMenu(*NoParam, grpc.ServerStreamingServer[Menu]) error {
...
func _CoffeeShop_GetMenu_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(CoffeeShopServer).GetMenu(m, &grpc.GenericServerStream[NoParam, Menu]{ServerStream: stream})
}
